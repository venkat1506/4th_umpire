...
#from fourth_umpire.predictions.pred import predict_1st_inn,predict_2nd_inn,pre_match_predict,get_team
from fourth_umpire.predictions.pred import *

#from web.fourth_umpire.predictions.pred import predict_1st_inn
from .forms import *
from .models import *
...
def contact(request):
    return HttpResponseRedirect('https://github.com/iamve7254/4th_umpire')
...
def prematch(request):
    if request.method == 'POST':
        ...
        if title_form.is_valid():
            ...
            team2 = title_form.cleaned_data['team2']
            venue = title_form.cleaned_data['venue']
            probab = pre_match_predict(0,team1,team2,venue)
            if probab > 0.5 :
                winner = get_team(team1)
                probab = probab * 100
            else:
