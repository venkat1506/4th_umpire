...
joblib.dump(regressor_bat, '2nd_inn_bat_win_wicket.pkl')

import pickle
with open('2nd_inn_bat_win_hot.pkl', 'wb') as pickle_file:
...
from sklearn.externals import joblib
joblib.dump(regressor_bowl, '2nd_inn_bowl_win_run.pkl')

import pickle
with open('2nd_inn_bowl_win_hot.pkl', 'wb') as pickle_file:
...
joblib.dump(regressor, '2nd_inn_end.pkl')

import pickle
with open('2nd_inn_end_hot.pkl', 'wb') as pickle_file:
